...
export const createLeadSchema = z.object({
  ...
  email: z.array(z.string().email("Invalid email format")).min(1, "At least one email is required"),
...
export const updateLeadSchema = z.object({
  ...
  phone: z.string().optional(),
  other_contact: z.string().optional(),
  email: z.array(z.string().email("Invalid email format")).min(1, "At least one email is required").optional(),
  location: z.string().optional(),
  budget: z.number().optional(),
  requirement: z.string().optional(),
  source_id: z.string().uuid("Invalid source ID").optional(),
