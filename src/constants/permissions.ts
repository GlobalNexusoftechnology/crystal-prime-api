...
export const MODULES: TOptionItem[] = [
  ...
  { key: "LEAD_MANAGEMENT", label: "Lead Management Module", value: "11" },
  {
    ...
    label: "Project Management Module",
    value: "12",
  },
  ...
  {
    key: "PROJECT_PERFORMANCE_REPORT",
    label: "Project Performance Report",
    value: "28",
  },
  { key: "LEAD_ANALYTICS_REPORT", label: "Lead Analytics Report", value: "29" },
  {
    key: "BUSINESS_ANALYSIS_REPORT",
    label: "Business Analysis Report",
    value: "30",
  },
  {
    key: "PUBLIC_BUSINESS_DASHBOARD",
    label: "Public Business Dashboard",
    value: "31",
  },
  ...
  { key: "STOCK_MANAGEMENT", label: "Stock Management", value: "99" },
];
...
export const getPermissionCode = (module: string, action: string) =>
  `${module}_${action}`;
